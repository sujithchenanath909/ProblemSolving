...
public class DuplicateInArray {
	 ...
	 public static Integer repeatedNumberNoModify(final List<Integer> A) {
		int repnum =-1;
	 ...
	 public static Set<Integer> repeatedNumberStreams(final List<Integer> A) {
		 
		 Set<Integer> set=new HashSet<Integer>();
		 
		Set<Integer> dupSet= A.stream().filter( e-> !set.add(e) ).collect(Collectors.toSet());
